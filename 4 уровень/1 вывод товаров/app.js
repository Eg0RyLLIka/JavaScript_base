...
function showCategory(category) {
    if (category === 'phones') {
        for (let phone of products.phones) {
            products_div.insertAdjacentHTML('beforeend', getProductMarkup(phone));
        };
    } else if (category === 'tablets') {
        for (let tablet of products.tablets) {
            products_div.insertAdjacentHTML('beforeend', getProductMarkup(tablet));
        };
    } else if (category === 'tv') {
        for (let tv of products.tv) {
            products_div.insertAdjacentHTML('beforeend', getProductMarkup(tv));
        };
    };
